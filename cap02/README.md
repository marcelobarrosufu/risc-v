...
Isso ocorre através de recursos de segurança como o secure boot, que permite somente a utilização de aplicações confiáveis, de acordo com o padrão RSA-3072, que se completa em 100ms, protegendo até mesmo dispositivos ligados de modo imediato [https://www.filipeflop.com/blog/apresentando-novo-mcu-esp32-c3-da-familia-espressif/]. Portanto, o chip foi desenvolvido para ter a capacidade de suprir as necessidades de aparelhos conectados tais como segurança, disponibilidade de Bluetooth de baixa energia e memória suficiente.
